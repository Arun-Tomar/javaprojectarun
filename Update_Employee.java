...
class Update_Employee extends Add_Employee implements ActionListener{
    ...
    void showData(String s){
        try{
            conn con = new conn();
            String str = "select * from employee_details where employee_id = '"+s+"'";
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                conn con = new conn();
                String str = "update employee_details set name='"+t1.getText()+"',father_name='"+t2.getText()+"',age='"+age+"',date_of_birth='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email_id='"+t5.getText()+"',education='"+t6.getText()+"',job_post='"+t7.getText()+"',aadhar_no='"+t8.getText()+"',employee_id='"+t9.getText()+"' where employee_id='"+id_emp+"'";
